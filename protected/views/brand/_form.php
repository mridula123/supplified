<?php
    ...
    'Brand'=>array('admin'),
    $model->store_front_id=>array('update','id'=>$model->store_front_id),
    'Update',
    );   
    
   $this->menu=array(
     array('label'=>'Manage Brand', 'url'=>array('brand/admin'))
    );
?>        
...
<?php endif; ?>
	...
	<div class="row">
        ...
        <?php echo $form->textField($model,'redirect_url',array('size'=>40,'maxlength'=>255)); ?>
