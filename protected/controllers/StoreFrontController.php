    ...
    */
	...
	public function actionCreate() {
        ...
        if (isset($_POST['StoreFront'])) {
				...
				if($chk)
				{
				   $apikey= substr($_POST['StoreFront']['store_front_name'],0,2);
				  if(!empty($_POST['StoreFront']['store_front_api_password']) && $_POST['StoreFront']['store_front_api_password']!=null && $_POST['StoreFront']['store_front_api_password']!='')
				  {
				   ...
				   $_POST['StoreFront']['store_front_api_password']= $password;
					  ...
					  Yii::app()->user->setFlash('success','StoreFront Created Successfully');
                      }					   
